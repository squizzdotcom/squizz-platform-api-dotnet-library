...
namespace Squizz.Platform.API.v1
{
    ...
    public class APIv1Constants
    {
        ...
        /// <summary>name of the platform's API endpoint to call to import an organisation's odwn sales order record(s) stored within an Ecommerce Standards Documents</summary>
        public const string API_ORG_ENDPOINT_IMPORT_SALES_ORDER_ESD = "import_sales_order_esd";
