...
namespace Squizz.Platform.API.v1.endpoint
{
    ...
    public class APIv1EndpointResponse: ESDocument
    {
        ...
        public const string ENDPOINT_RESULT_CODE_ERROR_ORG_CANNOT_BE_FOUND = "SERVER_ERROR_ORG_CANNOT_BE_FOUND";
        ...
        public const string ENDPOINT_RESULT_CODE_ERROR_INVOICE_LINE_NOT_MAPPED = "SERVER_ERROR_INVOICE_LINE_NOT_MAPPED";
        public const string ENDPOINT_RESULT_CODE_ERROR_INVOICE_SURCHARGE_NOT_MAPPED = "SERVER_ERROR_INVOICE_SURCHARGE_NOT_MAPPED";
        public const string ENDPOINT_RESULT_CODE_ERROR_INVOICE_LINE_TAXCODE_NOT_MAPPED = "SERVER_ERROR_INVOICE_LINE_TAXCODE_NOT_MAPPED";
