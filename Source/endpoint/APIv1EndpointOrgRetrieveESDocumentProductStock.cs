...
namespace Squizz.Platform.API.v1.endpoint
{
    ...
    /// </summary>
    public class APIv1EndpointOrgRetrieveESDocumentProductStock
    {
        ...
        public static APIv1EndpointResponseESD<ESDocumentStockQuantity> call(APIv1OrgSession apiOrgSession, int endpointTimeoutMilliseconds, string supplierOrgID, int recordsStartIndex, int recordsMaxAmount)
        {
            ...
            try{
                ...
                string endpointParams = "data_type_id=" + RETRIEVE_TYPE_ID_PRODUCT_STOCK + "&supplier_org_id=" + HttpUtility.UrlEncode(supplierOrgID) + "&records_start_index=" + recordsStartIndex + "&records_max_amount="+ recordsMaxAmount;
